...
//		log.info(resultTaskRAM5.toString());
		...
		ExecuteTask executeTaskHttpRequest2000n = new ExecuteTask(TaskType.HTTP_REQUEST,"ckeck if the port 2000 is connected", new String[] {"localhost","2000"} );
		...
		ExecuteTask executeTaskHttpRequest2000 = new ExecuteTask(TaskType.HTTP_REQUEST,"ckeck if the port 2000 is connected", new String[] {"localhost","2000"} );
		ResultTask resultTaskHttpRequest2000 = ResearchTest.executerClasse(executeTaskHttpRequest2000);
		log.info(resultTaskHttpRequest2000.toString());
